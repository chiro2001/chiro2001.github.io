...
var frontpage = [
	...
	"**继续访问本网站则代表您完全同意[《Henrize的聊天室服务协议》](agreement.html)**。",
	"加入聊天室输入昵称即可进行聊天，还有[**更多功能**](more.html)丰富聊天体验。",
	"这里有一些常用的聊天室，欢迎加入：",
	"闲聊休息室： ?lounge",
	"--------------------",
	"站长邮箱：mail@to.henrize.kim",
	"开源许可和制作人员：[版权页](copyright.html)",
...
var COMMANDS = {
	...
	onlineSet: function (args) {
		...
		pushMessage({ nick: '*', text: "欢迎加入聊天室！请保证您已经阅读并同意了[**服务协议**](agreement.html)。\n如果您所在的聊天室没有在线的用户，可以尝试加入聊天室 ?lounge\n在线的用户: " + nicks.join(", ") })
	},
